...
wget https://github.com/jailondanet2/new2022/raw/main/Painel-V2022/phpMyAdmin.conf -O /etc/httpd/conf.d/phpMyAdmin.conf
...
installweb(){
cd /var/www/html
wget https://github.com/jailondanet2/new2022/raw/main/Painel-V2022/gestorssh.zip
unzip gestorssh.zip
...
createdb(){
wget https://github.com/jailondanet2/new2022/raw/main/Painel-V2022/bdgestorssh.sql
...
cd $HOME || exit
wget -qO- https://github.com/jailondanet2/new2022/raw/main/Painel-V2022/uteste > /bin/usersteste.sh
wget -qO- https://github.com/jailondanet2/new2022/raw/main/Painel-V2022/backupauto > /bin/autobackup.sh
