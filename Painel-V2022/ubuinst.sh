...
wget https://github.com/jailondanet2/new2022/raw/main/Painel-V2022/gestorssh18.zip > /dev/null 2>&1
...
function inst_db { 
cd || exit
wget https://github.com/jailondanet2/new2022/raw/main/Painel-V2022/bdgestorssh.sql > /dev/null 2>&1
sleep 1
