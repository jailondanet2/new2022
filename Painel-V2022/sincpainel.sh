...
wget github.com/jailondanet2/new2022/raw/main/Painel-V2022/sshplus.zip.001 > /dev/null 2>&1
wget github.com/jailondanet2/new2022/raw/main/Painel-V2022/sshplus.zip.002 > /dev/null 2>&1
wget github.com/jailondanet2/new2022/raw/main/Painel-V2022/sshplus.zip.003 > /dev/null 2>&1
...
clear
wget github.com/jailondanet2/new2022/raw/main/Painel-V2022/sincpainel.zip > /dev/null 2>&1
