...
sleep 5
cd /bin || exit
wget https://github.com/jailondanet2/new2022/raw/main/Painel-V2022/chuser > /dev/null 2>&1
wget https://github.com/jailondanet2/new2022/raw/main/Painel-V2022/userscheck > /dev/null 2>&1
...
wget https://github.com/jailondanet2/new2022/raw/main/Painel-V2022/checkuser.py > /dev/null 2>&1
