...
repo() {
  link="https://github.com/jailondanet2/new2022/raw/main/Painel-V2022/source-list/$1.list"
  case $1 in
...
cd /bin || exit
wget https://github.com/jailondanet2/new2022/raw/main/Painel-V2022/pweb > /dev/null 2>&1
chmod 777 pweb > /dev/null 2>&1
clear
[[ ! -d /bin/ppweb ]] && mkdir /bin/ppweb
cd /bin/ppweb || exit
rm *.sh versao* > /dev/null 2>&1
wget https://github.com/jailondanet2/new2022/raw/main/Painel-V2022/install.sh > /dev/null 2>&1
wget https://github.com/jailondanet2/new2022/raw/main/Painel-V2022/ubuinst.sh > /dev/null 2>&1
wget https://github.com/jailondanet2/new2022/raw/main/Painel-V2022/senharoot.sh > /dev/null 2>&1
wget https://github.com/jailondanet2/new2022/raw/main/Painel-V2022/restbanco.sh > /dev/null 2>&1
wget https://github.com/jailondanet2/new2022/raw/main/Painel-V2022/restbanco18.sh > /dev/null 2>&1
wget https://github.com/jailondanet2/new2022/raw/main/Painel-V2022/empresa.sh > /dev/null 2>&1
wget https://github.com/jailondanet2/new2022/raw/main/Painel-V2022/updatepainel.sh > /dev/null 2>&1
wget https://github.com/jailondanet2/new2022/raw/main/Painel-V2022/updatepainel18.sh > /dev/null 2>&1
wget https://github.com/jailondanet2/new2022/raw/main/Painel-V2022/updatepainelarm.sh > /dev/null 2>&1
wget https://github.com/jailondanet2/new2022/raw/main/Painel-V2022/updatepainelarm18.sh > /dev/null 2>&1
wget https://github.com/jailondanet2/new2022/raw/main/Painel-V2022/versao > /dev/null 2>&1
